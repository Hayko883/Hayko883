<template>
  <div>
    <div class="bg-white dark:bg-[#242526] pt-[54px] pb-[25px] relative">
      <div class="absolute w-full py-[3px] flex justify-center capitalize bg-[#FFB400] top-0">
        <p class="text-[15px]  leading-6">most popular</p>
      </div>
      <div class="px-8 dark:text-white">
        <div class="text-center capitalize text-[#2B2B2B] dark:text-white">
          <h3 class="mb-[19px] font-semibold text-[24px] leading-[123.6%]">gold</h3>
          <h2 class="text-[32px] font-bold">$50.00<span class="text-[15px] font-normal">/hour</span></h2>
        ...
        <div>
          <ul class="capitalize">
            ...
            <li class="flex mb-4">
              <svg class="mr-[15px]" width="25" height="24" viewBox="0 0 25 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2_5885)">
                  <path
                      d="M10.3688 15.172L19.8998 5.979L21.367 7.393L10.3688 18L3.77002 11.636L5.23618 10.222L10.3688 15.172Z"
                      fill="#FFB400"/>
                </g>
                <defs>
                  <clipPath id="clip0_2_5885">
                    <rect width="24.8852" height="24" fill="white"/>
                  </clipPath>
                </defs>
              </svg>
        ...
        <div class=" text-center mt-[21px] ">
          <button
              class="bg-[#FFB400] dark:bg-[#242526] font-bold text-sm px-[41px] py-[11px] rounded-[30px] shadow-[0_1px_10px_-0px_rgba(0,0,0,0.15)] dark:shadow-[0_1px_10px_-0px_rgba(255,180,0,0.85)]">
            ORDER NOW
          </button>
        </div>
      </div>
